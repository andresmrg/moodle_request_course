<?php
$string['pluginname'] = 'Request Course';
$string['request_course:addinstance'] = 'Add a new Self-Study Available Courses block';
$string['request_course:myaddinstance'] = 'Add a new Self-Study Available Courses block to the My Moodle page';
...
$string['viewall'] = '<div style="text-align:center">See full list</div>';
